        ...
        let methods = {
			...
			*******************************/
			...
			appendHTML: function() {
                ...
                $("<div class='nbs-flexisel-nav-left'></div><div class='nbs-flexisel-nav-right'></div>").insertAfter(object.parent());
			...
			*******************************/
			setEventHandlers: function() {
				...
				let listParent = object.parent();
				let parentList = object.parent().parent();
				let childSet = object.children();
				let leftArrow = parentList.find($(".nbs-flexisel-nav-left"));
				let rightArrow = parentList.find($(".nbs-flexisel-nav-right"));
