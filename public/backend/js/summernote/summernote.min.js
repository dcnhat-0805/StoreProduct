    ...
    var S, T = function () {
        ...
        this.tab = function () {
            ...
            return M.createImage(a, c).then(function (a) {
                ...
                b.triggerEvent("image.uploads.error", a)
            })
        }, this.insertImages = function (d) {
            a.each(d, function (a, d) {
                var e = d.name;
                g.maximumImageFileSize && g.maximumImageFileSize < d.size ? b.triggerEvent("image.uploads.error", h.image.maximumFileSizeError) : M.readFileAsDataURL(d).then(function (a) {
                    return c.insertImage(a, e)
                }).fail(function () {
                    b.triggerEvent("image.uploads.error")
                })
            })
        }, this.insertImagesOrCallback = function (a) {
            g.callbacks.onImageUpload ? b.triggerEvent("image.uploads", a) : this.insertImages(a)
    ...
    var X = function (a) {
        ...
        var c = this, d = a.summernote.ui, e = b.layoutInfo.toolbar, f = b.options, g = f.langInfo,
            h = l.invertObject(f.keyMap[k.isMac ? "mac" : "pc"]), i = this.representShortcut = function (a) {
                var b = h[a];
                return f.shortcuts && b ? (k.isMac && (b = b.replace("CMD", "Ã¢Å’Ëœ").replace("SHIFT", "Ã¢â€¡Â§")), " (" + (b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
            };
        this.initialize = function () {
        ...
        this.createShortCutList = function () {
            ...
            var b = f.dialogsInBody ? a(document.body) : e,
                c = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.8</a> Ã‚Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Ã‚Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = d.dialog({
