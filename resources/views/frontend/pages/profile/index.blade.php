            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-md-9">
                        ...
                        <!-- manage my account -->
                        <div class="row manage-my-account box-info-order">
                            <div class="col-sm-12 pull-right page-root box-info-order">
                                <div class="row col-sm-12">
                                    <div class="col-sm-12 delivery-wrapper">
                                        <h3 class="title">Personal Profile<span class="lable-title"><a href="{{ route(FRONT_SHOW_EDIT_PROFILE) }}">EDIT</a></span></h3>
                                    </div>
                                </div>
                                <div class="row col-sm-12 box-info-order">
                                    <div class="delivery-wrapper">
                                        <div class="username">{{ $user->name }}</div>
                                        <div class="email">{{ $user->email }}</div>
                                        @if(!empty($user->phone))
                                            <div class="tel">Tel: {{ $user->phone }}</div>
                                        @endif
                                        @if(!empty($user->address))
                                            <div class="address">
                                                ...
                                                <span class="in-line">{{ App\Helpers\Helper::loadAddressByWardsId($user->address) }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
