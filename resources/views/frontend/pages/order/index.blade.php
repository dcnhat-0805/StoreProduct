                    ...
                    <div class="col-md-3">
                        <div class="sop-playground-nav">
                            <div class="member-info">
                                <p><span>Hello,&nbsp;</span><span id="sop_current_logon_user_name">{{ $order->order_name }}</span></p>
                            </div>
                            @if(Auth::check())
                                ...
                                <li class="item" id="My-Orders">
                                    <a class="active" href="" data-spm="My-Orders"><span>My Orders</span></a>
                                    <ul class="item-container">
                                ...
                                <div class="col-sm-6 pull-left">
                                    <div class="row col-sm-12 page-root box-info-order">
                                        <div class="delivery-wrapper">
                                            ...
                                            <span class="address">
                                                <span class="tag in-line" style="color: red; font-size: 20px">
