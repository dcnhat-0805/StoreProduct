    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="formAddProductAttribute">
                <div class="row">
                    <div class="col-sm-3 text-center">Product attribute name</div>
                    <div class="col-sm-3 text-center">Product attribute items name</div>
                    <div class="col-sm-3 text-center">Price</div>
                    <div class="col-sm-3">Is filterable</div>
                </div>
                ...
                @else
                    <div class="row jsProductAttribute ">
                        <div class="productAttribute">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="attributes[0][attribute_price]"
                                       placeholder="Product attribute price ..." value="">
                            </div>
                            <div class="col-sm-3">
                                <div class="jsCheckBox pull-left">
                                    <input type="checkbox" name="attributes[0][is_filterable]" value="1">
                                    <label><i></i> </label>
                                </div>
                            </div>
                        </div>
