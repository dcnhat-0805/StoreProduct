                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="category-status">
                                                <div class="jsRadio pull-left">
                                                    <input type="radio" value="1" id="display" name="category_status" checked {{ old('category_status') ? 'checked' : '' }}>
                                                    <label for="display" class="label__radio"><i></i> Display </label>
                                                </div>
                                                <div class="jsRadio pull-left">
                                                    <input type="radio" value="0" id="not__display" name="category_status" {{ old('category_status') == 0 && old('category_status') != null ? 'checked' : '' }}>
